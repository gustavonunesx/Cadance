...
```
Tarefas com `done = true` ou `restante = 0` são ignoradas.
...
- **D2** manhã: 12→A2 (conclui A2; 12<15 mas finaliza, então vale) + sobra 36
  de folga | tarde 96 → 90→B1 (B1 concluída) + 6 de folga | noite: nada.
